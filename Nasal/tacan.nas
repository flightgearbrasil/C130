# Fairchild tacan radio and navigation system
...
var ils_btn          = props.globals.getNode("sim/model/tacan/tacan-nav/selector-ils");
...
var nav0_freq_update = func {
	...
	if (! test) {
		setprop("sim/model/tacan/instrumentation/nav[0]/frequencies/freq-whole", 0);
	} else {
		setprop("sim/model/tacan/instrumentation/nav[0]/frequencies/freq-whole", test * 100);
	}
}
...
var tc_mag_hdg      = props.globals.getNode("sim/model/tacan/instrumentation/tacan/indicated-bearing-mag-deg");
...
var from_flag       = props.globals.getNode("sim/model/tacan/instrumentation/cdi/from-flag");
var to_flag         = props.globals.getNode("sim/model/tacan/instrumentation/cdi/to-flag");
var cdi_deflection  = props.globals.getNode("sim/model/tacan/instrumentation/cdi/needle-deflection");
...
var vhf = props.globals.getNode("sim/model/tacan/instrumentation/vhf");
