...
fire_gau12 = func
 {
 if (getprop("master/armed") and getprop("sim/model/A-10/weapons/gun-rate-switch") and getprop("power/on"))
  {
...
fire_40mm = func
 {
 if (getprop("master/armed") and getprop("sim/model/A-10/weapons/dual-AIM-9/aim9-knob") and getprop("power/on"))
  {
